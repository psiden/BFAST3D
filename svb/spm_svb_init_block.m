function [block] = spm_svb_init_block(Y,block)
...
block.mean_alpha=block.b_alpha_prior.*block.c_alpha_prior;
...
block.mean_beta = block.b_beta_prior.*block.c_beta_prior;
...
block.mean_lambda  = block.b_lambda_prior.*block.c_lambda_prior;
...
block.w_mean = zeros(size(block.w_mean));
...
block.a_mean = zeros(size(block.a_mean));
