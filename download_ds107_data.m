...
urlwrite(['https://github.com/psiden/BFAST3D/blob/master/data/ds107/condition_key.txt'],...
          [dataPath,'condition_key.txt']);
urlwrite(['https://github.com/psiden/BFAST3D/blob/master/data/ds107/task_contrasts.txt'],...
